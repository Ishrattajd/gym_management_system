...
const TrainerDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const enrolled = bookingsData.length;
    ...
    <div className="container-fluid p-0 bg-dark-custom min-vh-100 d-flex">
      ...
      <aside className="sidebar d-flex flex-column justify-content-between p-4 bg-dark-custom">
        <div>
          <div className="d-flex align-items-center gap-2 mb-5">
            ...
            <div>
              <h4 className="text-white fw-bold m-0 tracking-tight">THE FIT TRIBE</h4>
              <small
      ...
      <main className="main-content">
        <header className="mb-5">
          ...
          <p className="text-muted fs-5">Trainer Dashboard</p>
        </header>
        ...
        <div className="row g-4 mb-5">
          ...
          <div className="col-md-4">
            <div className="card h-100 p-4 bg-card-custom border-gray-custom">
              <div className="d-flex align-items-center gap-2 text-muted mb-3">
                <Users size={18} />
                <span className="small fw-bold">Total Enrolled</span>
              </div>
              <h2 className="text-white display-5 fw-bold m-0">
                {totalEnrolled}
              </h2>
          ...
          <div className="col-md-4">
            <div className="card h-100 p-4 bg-card-custom border-gray-custom">
              <div className="d-flex align-items-center gap-2 text-muted mb-3">
                <BookOpen size={18} />
                <span className="small fw-bold">Bookings Today</span>
              </div>
              <h2 className="text-white display-5 fw-bold m-0">
                {bookingsToday}
              </h2>
